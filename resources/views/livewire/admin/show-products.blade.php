<div>
    ...
    <x-slot name="header">
        <div class="flex items-center">
            ...
            <x-button-enlace class="ml-auto" href="{{ route('admin.product.create') }}">
                Agregar producto
            </x-button-enlace>
        </div>
    </x-slot>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            ...
                                            @else
                                                <img class="h-10 w-10 rounded-full object-cover"
                                                    src="https://images.pexels.com/photos/7210434/pexels-photo-7210434.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
                                                    alt="">
                                            @endif
